...
| INV-003 | FastAPI and static browser UI for upload, validation, rules, explicit AI request, evidence navigation and exports. Manually verify browser workflow or state tooling limit. | INV-002 merged | ready_for_review |
