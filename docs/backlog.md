...
| INV-004 | .NET and Python exporters, 15-case split corpus, offline evaluation and comparison runner. Cross-language findings match and offline evaluation reproduces. | INV-003 merged | ready_for_review |
